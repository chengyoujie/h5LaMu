...
package com.cyj.app.view.ui.laMuUI {
	...
	public class LMListItemUI extends View {
		...
		public var boxZhuXian:Box = null;
		public var combZhuXian:ComboBox = null;
		public var combZhuXianState:ComboBox = null;
		protected static var uiXML:XML =
			<View width="365" height="110">
			  ...
			  <ComboBox skin="png.guidecomp.combobox" x="43" y="50" width="79" height="23" var="combType" itemColors="0x262626,0xffe0ce,0xff861a,0x885202,0x3d3d3d" labelColors="0xf4a339,0xfedcaf,0xe0e0e0" scrollBarSkin="png.guidecomp.vscroll" labels="成就任务,等级,事件,关卡,其他,无用,新任务"/>
			  ...
			  <Box x="128" y="52" var="boxGuanKa">
			    <ComboBox skin="png.guidecomp.combobox" var="combGuanKa" width="161" height="23" scrollBarSkin="png.guidecomp.vscroll" visibleNum="15" itemColors="0x262626,0xffe0ce,0xff861a,0x885202,0x3d3d3d" labelColors="0xf4a339,0xfedcaf,0xe0e0e0" y="1"/>
			    <ComboBox skin="png.guidecomp.combobox" var="combGuanKaState" width="61" height="23" scrollBarSkin="png.guidecomp.vscroll" visibleNum="15" itemColors="0x262626,0xffe0ce,0xff861a,0x885202,0x3d3d3d" labelColors="0xf4a339,0xfedcaf,0xe0e0e0" x="168" labels="退出,进入"/>
			  </Box>
			  <Clip skin="png.guidecomp.clip_格子选中" x="0" y="0" width="366" height="109" sizeGrid="10,10,10,10,1" name="selectBox" mouseEnabled="false"/>
			  <Box x="128" y="49" var="boxZhuXian">
			    <ComboBox skin="png.guidecomp.combobox" var="combZhuXian" width="161" height="23" scrollBarSkin="png.guidecomp.vscroll" visibleNum="15" itemColors="0x262626,0xffe0ce,0xff861a,0x885202,0x3d3d3d" labelColors="0xf4a339,0xfedcaf,0xe0e0e0" y="1"/>
			    <ComboBox skin="png.guidecomp.combobox" var="combZhuXianState" width="61" height="23" scrollBarSkin="png.guidecomp.vscroll" visibleNum="15" itemColors="0x262626,0xffe0ce,0xff861a,0x885202,0x3d3d3d" labelColors="0xf4a339,0xfedcaf,0xe0e0e0" x="168" labels="接收,进行中,完成"/>
			  </Box>
			</View>;
