	...
	public class ScrollBar extends Component {
		...
		public function set target(value:InteractiveObject):void {
			if (_target) {
				...
				_target.removeEventListener(MouseEvent.RIGHT_MOUSE_DOWN, onTargetMouseDown);
			}
			_target = value;
			if (value) {
				...
				if (_touchScrollEnable) {
					_target.addEventListener(MouseEvent.RIGHT_MOUSE_DOWN, onTargetMouseDown);
				}
			}
		}
		...
		protected function onTargetMouseDown(e:MouseEvent):void {
			...
			if (!this.contains(e.target as DisplayObject)) {
				App.stage.addEventListener(MouseEvent.RIGHT_MOUSE_UP, onStageMouseUp2);
		...
		protected function onStageMouseUp2(e:MouseEvent):void {
			App.stage.removeEventListener(MouseEvent.RIGHT_MOUSE_UP, onStageMouseUp2);
